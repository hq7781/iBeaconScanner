...
#import "BLEDeviceNotificationSetting.h"
...
typedef NS_ENUM(NSUInteger, NotificationServiceParamID) {
    ...
    NotificationServiceParamIDNotifySoundPattern    = 0x2B,
};

typedef NS_ENUM(NSInteger, BLENotifyCategoryType) {
    BLENotifyCategoryTypeGeneral           = 0,
    BLENotifyCategoryTypeEtc               = 1,
    BLENotifyCategoryTypePhoneIncomingCall = 2,
    BLENotifyCategoryTypePhoneInCall       = 3,
    BLENotifyCategoryTypePhoneIdle         = 4,
    BLENotifyCategoryTypeMail              = 5,
    BLENotifyCategoryTypeSchedule          = 6
};
...
/**
 ...
 @param notifyCategoryType  通知カテゴリタイプ
 
 @return 送信するデータ
 */
- (NSData *)sendNotifyInformationWithDeviceNotificationSetting:(BLEDeviceNotificationSetting *)deviceNotificationSetting notifyCategoryType:(NSInteger)type;
