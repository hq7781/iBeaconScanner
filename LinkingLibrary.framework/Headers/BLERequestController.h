...
/**
 ...
 @param ledSettingDict settingInformationDataの値を設定値に変更して送信
 @param vibrationSettingDict settingInformationDataの値を設定値に変更して送信
 @param notifySoundSettingDict settingInformationDataの値を設定値に変更して送信
 @param disconnect YESの場合は即時切断、NOの場合は一定間隔をおいて切断する(disconnectTimeが0の場合は切断されない)
 */
- (void)setSelectSettingInformationWithLED:(NSDictionary *)ledSettingDict
                                 vibration:(NSDictionary *)vibrationSettingDict
                               notifySound:(NSDictionary *)notifySoundSettingDict
                                peripheral:(CBPeripheral *)peripheral
                                disconnect:(BOOL)disconnect;
...
/**
 ...
 @param deviceNotificationSetting   通知情報
 @param peripheral                  送信するデバイスのペリフェラル
 @param disconnect                  YESの場合は即時切断、NOの場合は一定間隔をおいて切断する(disconnectTimeが0の場合は切断されない)
 
 @return 識別ID 戻り値の識別IDが-1の場合はパラメータの設定に不備があります。
 */
- (int)sendGeneralInformation:(BLEDeviceNotificationSetting *)deviceNotificationSetting
                   peripheral:(CBPeripheral *)peripheral
                   disconnect:(BOOL)disconnect;
...
/**
 ...
 @return 識別ID 戻り値の識別IDが-1の場合はパラメータの設定に不備があります。
 */
- (int)sendEtcInformation:(BLEDeviceNotificationSetting *)deviceNotificationSetting
               peripheral:(CBPeripheral *)peripheral
               disconnect:(BOOL)disconnect;
...
/**
 ...
 @return 識別ID 戻り値の識別IDが-1の場合はパラメータの設定に不備があります。
 */
- (int)sendPhoneIncomingCallInformation:(BLEDeviceNotificationSetting *)deviceNotificationSetting
                             peripheral:(CBPeripheral *)peripheral
                             disconnect:(BOOL)disconnect;
...
/**
 ...
 @return 識別ID 戻り値の識別IDが-1の場合はパラメータの設定に不備があります。
 */
- (int)sendPhoneInCallInformation:(BLEDeviceNotificationSetting *)deviceNotificationSetting
                       peripheral:(CBPeripheral *)peripheral
                       disconnect:(BOOL)disconnect;
...
/**
 ...
 @return 識別ID 戻り値の識別IDが-1の場合はパラメータの設定に不備があります。
 */
- (int)sendPhoneIdleInformation:(BLEDeviceNotificationSetting *)deviceNotificationSetting
                     peripheral:(CBPeripheral *)peripheral
                     disconnect:(BOOL)disconnect;
...
/**
 ...
 @return 識別ID 戻り値の識別IDが-1の場合はパラメータの設定に不備があります。
 */
- (int)sendMailInformation:(BLEDeviceNotificationSetting *)deviceNotificationSetting
                peripheral:(CBPeripheral *)peripheral
                disconnect:(BOOL)disconnect;
...
/**
 ...
 @return 識別ID 戻り値の識別IDが-1の場合はパラメータの設定に不備があります。
 */
- (int)sendScheduleInformation:(BLEDeviceNotificationSetting *)deviceNotificationSetting
                    peripheral:(CBPeripheral *)peripheral
                    disconnect:(BOOL)disconnect;
@end
