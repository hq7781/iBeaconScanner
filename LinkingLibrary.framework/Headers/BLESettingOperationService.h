...
@property (nonatomic)BLEDeviceSetting *selectDevice;
...
typedef NS_ENUM(NSUInteger, SettingOperationNameType) {
    ...
    SettingOperationNameTypeNotifySoundPatternName          = 4,
    SettingOperationNameTypeNotificationDurationPatternName = 5,
    SettingOperationNameTypeReserved                        = 6,
};
...
typedef NS_ENUM(NSUInteger, SettingOperationSettingInformationDataIdentifier) {
    ...
    SettingOperationSettingInformationDataIdentifierNotifySound = 0x02,
    SettingOperationSettingInformationDataIdentifierTime        = 0x03,
};
...
/**
 ...
 @param ledSetting          settingInformationDataの値を設定値に変更
 @param vibrationSetting    settingInformationDataの値を設定値に変更
 @param notifySoundSetting  settingInformationDataの値を設定値に変更
 @param settingType         設定値識別子 0x00=設定要求 0x01=設定デモ要求 0x02=設定デモ停止要求
 
 @return 送信するデータ
 */
- (NSData *)makeSelectSettingInformationMessageWithLED:(NSDictionary *)ledSetting vibration:(NSDictionary *)vibrationSetting notifySound:(NSDictionary *)notifySoundSetting settingType:(Byte)settingType;
